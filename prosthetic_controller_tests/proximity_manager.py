...
MUX1_ADDRESS = 0x70      # First multiplexer
MUX2_ADDRESS = 0x71      # Second multiplexer
...
class ProximityManager:
    ...
    def __init__(self, sampling_rate=20):  # 20Hz default sampling rate
        ...
        # Thresholds (in mm)
        self.proximity_threshold = 30  # Distance beyond which no action is taken
        self.contact_threshold = 5     # Distance at which contact is assumed
    ...
    def stop(self):
        ...
        self.bus.close()
        print("Proximity manager stopped")
