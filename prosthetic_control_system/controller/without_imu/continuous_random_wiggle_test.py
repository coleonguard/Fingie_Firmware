#!/usr/bin/env python3
"""
Continuous Random Wiggle Test for Prosthetic Hand.

This script implements continuous random finger wiggling with variable timing
and smart direction changes to stay within angle constraints. Key features:
...
logger = logging.getLogger("ContinuousWiggleTest")
...
class ContinuousWiggleController:
    """
    Controller that implements continuous random wiggling with variable timing.
    ...
    def __init__(
        ...
        """
        Initialize the continuous random wiggle controller.
        ...
        logger.info(f"Continuous wiggle controller initialized with phase_mean_duration={phase_mean_duration}s, std_dev={phase_std_dev}s")
    ...
    def start(self):
        ...
        logger.info("Continuous wiggle controller started")
    ...
    def stop(self):
        ...
        logger.info("Continuous wiggle controller stopped")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Continuous Random Wiggle Test')
    ...
    try:
        ...
        controller = ContinuousWiggleController(
        ...
        # Monitor loop
        print("\nContinuous Random Wiggle Test Active - Press Ctrl+C to stop")
        print("----------------------------------------------------")
        ...
        while running:
            try:
                ...
                # Only show proximity values in sensor phase
