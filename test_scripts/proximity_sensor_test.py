...
def test_vl6180x_single_sensor():
    """Test reading distance from a single VL6180X sensor through a specific multiplexer channel."""
    select_channel(MUX_ADDRESS, CHANNEL)  # Enable channel 4 on multiplexer at 0x70
